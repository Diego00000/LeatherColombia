...
namespace LeatherColombia.Controllers
{
    public class MetodoPagosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MetodoPagoID,Nombre,Referencia")] MetodoPago metodoPago)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MetodoPagoID,Nombre,Referencia")] MetodoPago metodoPago)
        {
